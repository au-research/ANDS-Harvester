...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_defaultOriginatingSource" select="'Office of Environment and Heritage NSW'"/>
    <xsl:param name="global_acronym" select="'OEH'"/>
    <xsl:param name="global_originatingSource" select="'Office of Environment and Heritage NSW'"/> <!-- Only used as originating source if organisation name cannot be determined from Point Of Contact -->
