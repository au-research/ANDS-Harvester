...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_originatingSource" select="'TERN'"/> <!-- Only used as originating source if organisation name cannot be determined from Point Of Contact -->
    <xsl:param name="global_group" select="'TERN'"/>
    <xsl:param name="global_baseURI" select="'http://geonetwork.tern.org.au/geonetwork'"/>
    <xsl:param name="global_catalogueURI" select="'http://geonetwork.tern.org.au/geonetwork/srv/eng/catalog'"/>
    <xsl:param name="global_rightsURI" select="'http://geonetwork.tern.org.au/geonetwork'"/>
