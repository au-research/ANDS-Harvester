...
class test_jsonld_harvester(unittest.TestCase):
    ...
    def not_test_small_text_site_map(self):
        ...
        harvestInfo['data_source_id'] = '22'
        harvestInfo['harvest_id'] = '1'
        harvestInfo['batch_number'] = "BATCHNUMBER"
        harvestInfo['advanced_harvest_mode'] = "STANDARD"
        harvestInfo['xsl_file'] = "/Users/leomonus/dev/ands/harvester/tests/resources/schemadotorg2rif.xsl"
    ...
    def not_test_text_site_map(self):
        ...
        harvestInfo['data_store_path'] = myconfig.data_store_path
        harvestInfo['response_url'] = myconfig.response_url
        harvestInfo['data_source_id'] = '999'
        harvestInfo['harvest_id'] = '99'
        harvestInfo['batch_number'] = "BATCHNUMBER"
        harvestInfo['advanced_harvest_mode'] = "STANDARD"
    ...
    def not_test_aurin_site_map(self):
        ...
        harvestInfo['data_store_path'] = myconfig.data_store_path
        harvestInfo['response_url'] = myconfig.response_url
        harvestInfo['data_source_id'] = '600'
        harvestInfo['harvest_id'] = '1'
        harvestInfo['batch_number'] = "aurin"
        harvestInfo['advanced_harvest_mode'] = "STANDARD"
        harvestInfo['xsl_file'] = ""
        harvestInfo['mode'] = "HARVEST"
        harvester = JSONLDHarvester(harvestInfo)
    ...
    def not_test_xml_site_map_earthcube(self):
        harvestInfo = {}
        harvestInfo['uri'] = 'https://demo.ands.org.au/page/sitemap'
        harvestInfo['provider_type'] = 'JSONLD'
        harvestInfo['harvest_method'] = 'JSONLD'
        harvestInfo['data_store_path'] = myconfig.data_store_path
        harvestInfo['response_url'] = myconfig.response_url
        harvestInfo['data_source_id'] = 'opentopography'
        harvestInfo['harvest_id'] = '9'
        harvestInfo['batch_number'] = "1"
        harvestInfo['advanced_harvest_mode'] = "STANDARD"
        harvestInfo['xsl_file'] = ""
        harvestInfo['mode'] = "HARVEST"
        harvester = JSONLDHarvester(harvestInfo)
